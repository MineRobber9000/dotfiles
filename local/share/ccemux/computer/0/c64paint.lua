...
palPal.loadPalette(term,palCollection.palettes.c64)
...
local leftColour, rightColour = palCollection.colours.c64.white, nil
local canvasColour = palCollection.colours.c64.black
...
local function drawInterface()
    ...
    term.setBackgroundColour(palCollection.colours.c64.black)
    term.setTextColour(palCollection.colours.c64.yellow)
    term.clearLine()
    term.write(fMessage)
    ...
    term.setTextColour( palCollection.colours.c64.lightGrey )
    term.write("\127\127")
...
local function accessMenu()
    ...
    while true do
        ...
        term.setCursorPos(1,h)
        term.clearLine()
        term.setTextColour(palCollection.colours.c64.white)
